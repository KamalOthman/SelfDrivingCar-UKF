...
void UKF::ProcessMeasurement(MeasurementPackage meas_package) {
    /**
     ...
     measurements.
     */
    cout << "Start initial process measurement"<<endl;
    if (!is_initialized_){
        cout << "UKF:: " << endl;
        x_ << 1,1,1,1,1;
        P_ <<   1,0,0,0,0,
        ...
        if (meas_package.sensor_type_ == MeasurementPackage::RADAR) {
            cout << "Radar process measurement"<<endl;
            ...
            cout << "Laser process measurement"<<endl;
        ...
        cout << "End of initial process measurement"<<endl;
        return;
    }
}
...
void UKF::UpdateLidar(MeasurementPackage meas_package) {
     ...
     */
    cout << "Start updating with Lidar " << endl;
...
void UKF::UpdateRadar(MeasurementPackage meas_package) {
     ...
     */
    cout << "Start updating with Radar "<<endl;
